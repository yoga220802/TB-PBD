...
import ApotekerScreen from './components/screens/usersScreens/transaction/apotekerScreen';
import PustakawanScreen from './components/screens/usersScreens/kelolaObat/kelolaStokScreen';
import KepalaApotekerScreen from './components/screens/usersScreens/kepalaApoteker/kepalaApotekScreen';
...
function App() {
  // Membersihkan localStorage saat aplikasi dimulai
  // useEffect(() => {
  //   localStorage.clear();
  // }, []);
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/apoteker" element={<PrivateRoute><ApotekerScreen setToken={setToken} setRole={setRole} userDetails={userDetails} logout={logout} /></PrivateRoute>} />
        ...
        <Route path="/kepala-apoteker" element={<PrivateRoute><KepalaApotekerScreen setToken={setToken} setRole={setRole} userDetails={userDetails} logout={logout} /></PrivateRoute>} />
